    ...
    <section id="wrapper">
        <div class="login-register"
            ...
            <div class="login-box card">
                <div class="card-body">
                    {{ Form::open(['url' => route('admin.signup'), 'class'=>'form-horizontal form-material','method'=>'post', 'id'=>'loginform'])  }}
                    <h3>@include('flash::message')</h3>
                    @if(session()->has('password_reset'))
                        <h3> {{session()->get('password_reset')}} </h3>
                    @endif
                    <h3>@if(Session::has('password_reset')) {{Session::get('variableName')}}
                        @endif</h3>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                ...
                                <label for="checkbox-signup"> Send me OurGhostery updates & promotions. </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Already have an account? <a href="{{route('admin.login')}}" class="text-info m-l-5"><b>Log In</b></a></p>
                        </div>
                    </div>
                    </form>
