...
<input type="submit" class="submit" value="Submit">
            ...
            success:function(data){
              ...
              console.log(typeof res['Results']['First Name']);
                if (typeof res['Results']['First Name'] == "undefined") {
                  ...
                  lead_name = res['Results']['First Name']+' '+res['Results']['Last Name'];
                  ...
                  saveToListing(company_name, zip_code.trim().substring(0,5), country, prov,b,lead_name, email,phone,city,street);
                }
 ...
 function saveToListing(name ,zip,country,prov,b, lead_name, email, phone,city,street){
 	startLoader()  
 	var name=  name;
 	if (country == "Canada") {
 		var zip = prov;
 	...
 	$.ajax({
        type:'post',
        data:{"_token": "{{ csrf_token() }}",'name':name,'zip':zip,'badge_id':b,'lead_name':lead_name,'email':email,'phone':phone,'country':country,'city':city,'street':street,'state':prov,},
